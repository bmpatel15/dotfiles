...
// --- CONFIGURATION ---
// Trail color follows Ghostty's cursor color (Ethereal peach #ffcead), so the
// comet tail always matches the cursor. Tuned subtle: short duration, quick fade.
...
const float DURATION = 0.12; // in seconds — subtle, quick-settling comet tail
